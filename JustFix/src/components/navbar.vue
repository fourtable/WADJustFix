    ...
    <nav class="navbar navbar-expand-md">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img src="../assets/newlogo.png" alt="JusFix Logo" width="120" height="60" class="d-inline-block align-text-top" />
        </a>
        <button
        ...
        <div class="collapse navbar-collapse mx-auto" id="navbar">
          ...
          <ul v-if="!username" class="nav-buttons navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <router-link :to="{name :'register'}" class="btn btn-dark d-md-inline d-none" role="button">Register</router-link>
              <router-link :to="{name :'register'}" class="nav-link d-md-none fw-bold" role="button">Register</router-link>
            </li>
          </ul>
  
          <!-- Profile Icon -->
          <div v-else class="dropdown">
              <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">{{username}}
              ...
              <ul class="dropdown-menu dropdown-menu-start" aria-labelledby="dropdownMenuButton">
                  ...
                  <li>
                      <router-link class="dropdown-item btn" @click="logout" :to="{name :'login'}">Logout</router-link> <!-- Logout Option -->
                  </li>
              </ul>
          </div>
        </div>
